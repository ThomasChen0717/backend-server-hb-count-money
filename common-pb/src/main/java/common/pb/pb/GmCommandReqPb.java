...
public class GmCommandReqPb {
    /** gmCommandId:1:加钱 2:装备全解锁命令 3:载具全解锁命令 4:富豪全解锁 5:boss全解锁 6:属性升级 **/
    @NotNull
    int gmCommandId;

    /** gm命令对应的信息:加钱命令:{"money",10},装备全解锁命令:{},载具全解锁命令:{},富豪全解锁:{},boss全解锁:{},属性升级:{"attributeType":1,"targetLevel":1000} **/
    @NotNull
